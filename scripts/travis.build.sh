...
sudo mysql -unimrodbackend -p123456 nimrodbackend < db/mysql/nimrodbackend/nimrodbackend.sql
sudo mysql -unimrodbackend -p123456 nimrodbackend < db/mysql/oauth2/oauth2.sql
sudo mysql -unimrodbackend -p123456 nimrodbackend < db/mysql/quartz/tables_mysql_innodb.sql
