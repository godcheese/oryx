...
INSERT INTO `user` VALUES (1, 'normal_user', '$2a$10$2ASJsYX1q5AMjHCji6DkrOt/mmS4D1nCXwnUW4kt.n/FvONR6Kjiq', NULL, 'normal_user@outlook.com', 1, 1, 0, '测试备注', NULL, '2019-05-09 03:25:39', '2018-06-27 21:22:40');
INSERT INTO `user` VALUES (2, 'admin', '$2a$10$2ASJsYX1q5AMjHCji6DkrOt/mmS4D1nCXwnUW4kt.n/FvONR6Kjiq', NULL, 'admin@outlook.com', 1, 1, 1, '测试备注', NULL, '2019-05-09 03:25:44', '2018-06-27 21:22:40');
INSERT INTO `user` VALUES (3, 'system_admin', '$2a$10$2ASJsYX1q5AMjHCji6DkrOt/mmS4D1nCXwnUW4kt.n/FvONR6Kjiq', NULL, 'godcheese@outlook.com', 1, 1, 1, '测试备注', NULL, '2019-06-20 07:59:19', '2018-06-27 21:22:40');
...
CREATE TABLE `view_menu` (
                             ...
                             `gmt_created` datetime DEFAULT NULL COMMENT '创建时间',
                             PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='视图菜单表';

-- ----------------------------
-- Records of view_menu
-- ----------------------------
INSERT INTO `view_menu` VALUES (1, 'API 管理', 'bars', '/user/api/page_all', 3, 0, '', '2019-06-06 02:52:53', '2018-07-01 21:28:04');
...
INSERT INTO `view_menu` VALUES (7, '发送邮件', 'plus-circle', '/mail/send', 4, 0, '', '2019-01-21 02:58:57', '2018-07-08 13:20:28');
INSERT INTO `view_menu` VALUES (8, '邮件队列', 'mail', '/mail/page_all', 4, 0, '', '2019-01-21 02:59:02', '2018-07-08 13:22:30');
INSERT INTO `view_menu` VALUES (9, '操作日志', 'info-circle', '/system/operation_log/page_all', 2, 0, '', '2018-12-11 03:13:08', '2018-08-06 16:47:15');
INSERT INTO `view_menu` VALUES (10, '附件管理', 'file', '/system/attachment/page_all', 2, 0, '', '2018-10-20 19:07:33', '2018-10-20 19:01:23');
INSERT INTO `view_menu` VALUES (11, '部门管理', 'cluster', '/user/department/list_all', 3, 0, '', '2018-12-20 02:43:28', '2018-12-20 02:43:28');
INSERT INTO `view_menu` VALUES (14, '定时任务', '', '/quartz/job/page_all', 2, 0, '', '2019-02-11 01:17:37', '2019-02-11 01:17:37');
INSERT INTO `view_menu` VALUES (15, '视图菜单管理', 'bars', '/user/view_menu/page_all', 3, 0, '', '2019-06-13 04:21:31', '2019-06-13 11:37:14');
INSERT INTO `view_menu` VALUES (16, '工作台', 'dashboard', '/workbench', 1, 0, '', '2019-06-17 06:31:23', '2019-06-17 06:28:37');
...
-- ----------------------------
INSERT INTO `view_menu_category` VALUES (1, '系统管理', 'setting', NULL, 0, 'dsds', '2019-06-06 02:51:28', '2018-07-01 21:28:04');
...
INSERT INTO `view_menu_category` VALUES (4, '电子邮箱', 'mail', 2, 0, '', '2018-07-08 13:19:57', '2018-07-08 13:19:57');
...
CREATE TABLE `role_view_menu` (
                                  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'id',
                                  `role_id` bigint(20) unsigned NOT NULL COMMENT '角色 id',
                                  `view_menu_id` varchar(255) NOT NULL COMMENT '菜单名称 id',
                                  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='角色视图菜单分类表';

-- ----------------------------
-- Records of role_view_menu
-- ----------------------------
BEGIN;
INSERT INTO `role_view_menu` VALUES (1, 3, '1');
INSERT INTO `role_view_menu` VALUES (2, 3, '2');
INSERT INTO `role_view_menu` VALUES (3, 3, '3');
INSERT INTO `role_view_menu` VALUES (4, 3, '4');
INSERT INTO `role_view_menu` VALUES (5, 3, '5');
INSERT INTO `role_view_menu` VALUES (6, 3, '6');
INSERT INTO `role_view_menu` VALUES (7, 3, '7');
INSERT INTO `role_view_menu` VALUES (8, 3, '8');
INSERT INTO `role_view_menu` VALUES (9, 3, '9');
INSERT INTO `role_view_menu` VALUES (10, 3, '10');
INSERT INTO `role_view_menu` VALUES (11, 3, '11');
INSERT INTO `role_view_menu` VALUES (20, 2, '1');
INSERT INTO `role_view_menu` VALUES (21, 2, '2');
INSERT INTO `role_view_menu` VALUES (22, 2, '3');
INSERT INTO `role_view_menu` VALUES (23, 2, '4');
INSERT INTO `role_view_menu` VALUES (24, 2, '5');
INSERT INTO `role_view_menu` VALUES (25, 2, '6');
INSERT INTO `role_view_menu` VALUES (26, 2, '9');
INSERT INTO `role_view_menu` VALUES (27, 2, '10');
INSERT INTO `role_view_menu` VALUES (28, 2, '11');
INSERT INTO `role_view_menu` VALUES (29, 2, '14');
INSERT INTO `role_view_menu` VALUES (30, 3, '13');
INSERT INTO `role_view_menu` VALUES (31, 3, '12');
INSERT INTO `role_view_menu` VALUES (32, 3, '15');
INSERT INTO `role_view_menu` VALUES (33, 3, '16');
COMMIT;
...
CREATE TABLE `role_view_menu_category` (
                                           `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'id',
                                           `role_id` bigint(20) unsigned NOT NULL COMMENT '角色 id',
                                           `view_menu_category_id` varchar(255) NOT NULL COMMENT '分类名称',
                                           PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='角色视图菜单分类表';

-- ----------------------------
-- Records of role_view_menu_category
-- ----------------------------
BEGIN;
INSERT INTO `role_view_menu_category` VALUES (1, 3, '1');
INSERT INTO `role_view_menu_category` VALUES (2, 3, '2');
INSERT INTO `role_view_menu_category` VALUES (3, 3, '3');
INSERT INTO `role_view_menu_category` VALUES (4, 3, '4');
INSERT INTO `role_view_menu_category` VALUES (5, 2, '1');
INSERT INTO `role_view_menu_category` VALUES (9, 2, '3');
INSERT INTO `role_view_menu_category` VALUES (10, 2, '2');
INSERT INTO `role_view_menu_category` VALUES (11, 2, '4');
COMMIT;
