...
CREATE TABLE `dictionary`  (
  ...
  `gmt_created` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 43 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '数据字典表' ROW_FORMAT = Dynamic;
...
INSERT INTO `dictionary` VALUES (38, 'QUARTZ_TRIGGER_STATE', 'Quartz 任务状态', '等待', 'WAITING', 'WAITING', 1, 15, 0, '', NULL, NULL);
INSERT INTO `dictionary` VALUES (39, 'QUARTZ_TRIGGER_STATE', 'Quartz 任务状态', '正常执行', 'ACQUIRED', 'ACQUIRED', 1, 15, 0, '', NULL, NULL);
INSERT INTO `dictionary` VALUES (40, 'QUARTZ_TRIGGER_STATE', 'Quartz 任务状态', '暂停', 'PAUSED', 'PAUSED', 1, 15, 0, '', NULL, NULL);
INSERT INTO `dictionary` VALUES (41, 'QUARTZ_TRIGGER_STATE', 'Quartz 任务状态', '阻塞', 'BLOCKED', 'BLOCKED', 1, 15, 0, '', NULL, NULL);
INSERT INTO `dictionary` VALUES (42, 'QUARTZ_TRIGGER_STATE', 'Quartz 任务状态', '错误', 'ERROR', 'ERROR', 1, 15, 0, '', NULL, NULL);
...
CREATE TABLE `operation_log`  (
  ...
  `stackTrace` text CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL COMMENT '异常堆栈',
...
CREATE TABLE `role_view_menu`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '角色关联视图菜单表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of role_view_menu
-- ----------------------------
INSERT INTO `role_view_menu` VALUES (1, 999, 1);
...
INSERT INTO `user` VALUES (999, 'system_admin', '$2a$10$2ASJsYX1q5AMjHCji6DkrOt/mmS4D1nCXwnUW4kt.n/FvONR6Kjiq', NULL, 'godcheese@outlook.com', 1, 1, 1, '测试备注', NULL, '2019-06-20 07:59:19', '2018-06-27 21:22:40');
