package com.gioov.oryx.user;

import com.gioov.oryx.common.Url;
...
public class User {
    ...
    public static class Page {
        ...
        public static final String LOGIN_PATH_PATTERN = LOGIN + Url.ALL_PATH_PATTERN;

        public static final String REGISTER = USER + "/register";
        public static final String REGISTER_PATH_PATTERN = REGISTER + Url.ALL_PATH_PATTERN;

        public static final String LOGOUT = USER + "/logout";
        public static final String LOGOUT_PATH_PATTERN = LOGIN + Url.ALL_PATH_PATTERN;
