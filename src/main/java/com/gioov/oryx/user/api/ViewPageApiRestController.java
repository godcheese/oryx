...
import com.gioov.oryx.user.service.ViewPageApiService;
...
public class ViewPageApiRestController {
    ...
    private static final String VIEW_PAGE_API = "/API/USER/VIEW_PAGE_API";
...
//    @GetMapping(value = "/is_associated_by_view_page_id_and_api_id")
