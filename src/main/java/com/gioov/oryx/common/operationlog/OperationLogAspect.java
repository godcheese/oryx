...
public class OperationLogAspect {
    ...
    @Pointcut("@annotation(com.gioov.oryx.common.operationlog.OperationLog)")
...
//            LOGGER.info("{}", returning.getClass().toString());
//            Field[] fields = returning.getClass().getDeclaredFields();
//            for(Field field : fields){
//                field.setAccessible(true);
//                map.put(field.getName(), field.get(returning));
//                LOGGER.info("{}={}",field.getName(), field.get(returning));
//            }
//
//            Field[] fields2 = returning.getClass().getFields();
