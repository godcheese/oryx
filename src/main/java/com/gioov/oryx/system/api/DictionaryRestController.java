...
//     */
//    @OperationLog(value = "获取所有数据字典", type = OperationLogType.API)
...
//    }
    ...
    @PreAuthorize("hasRole('" + SYSTEM_ADMIN + "') OR hasAuthority('" + DICTIONARY + "/PAGE_ALL_BY_DICTIONARY_CATEGORY_ID_LIST')")
