...
public class FileRestController {
    ...
    public ResponseEntity<FileEntity> uploadOne(@RequestParam MultipartFile file) throws BaseResponseException {
    ...
    public ResponseEntity<Pagination<FileEntity>> pageAllImage(@RequestParam Integer page, @RequestParam Integer rows) {
        return new ResponseEntity<>(fileService.pageAllImage(page, rows), HttpStatus.OK);
    }
