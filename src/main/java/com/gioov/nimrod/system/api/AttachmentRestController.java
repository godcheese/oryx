...
public class AttachmentRestController {
    ...
    public ResponseEntity<Pagination<AttachmentEntity>> pageAll(@RequestParam Integer page, @RequestParam Integer rows) {
        return new ResponseEntity<>(attachmentService.pageAll(page, rows), HttpStatus.OK);
    }
    ...
    public ResponseEntity<Pagination<AttachmentEntity>> pageAllImage(@RequestParam Integer page, @RequestParam Integer rows) {
        return new ResponseEntity<>(attachmentService.pageAllImage(page, rows), HttpStatus.OK);
    }
}
