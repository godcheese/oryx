...
public class DepartmentRestController {
    ...
    @OperationLog(value = "根据子部门 id 获a取所有父级部门", type = OperationLogType.API)
    ...
    public ResponseEntity<List<AntdTree>> listAllAsTree() {
     ...
     */
//    @OperationLog(value = "分页获取所有父级部门", type = OperationLogType.API)
//    @PreAuthorize("hasRole('" + SYSTEM_ADMIN + "') OR hasAuthority('" + DEPARTMENT + "/PAGE_ALL')")
//    @GetMapping(value = "/page_all")
//    public ResponseEntity<Pagination<DepartmentEntity>> pageAll(@RequestParam Integer page, @RequestParam Integer rows) {
//        return new ResponseEntity<>(departmentService.pageAll(page, rows), HttpStatus.OK);
//    }
    ...
    public ResponseEntity<List<DepartmentEntityAsAntdTable>> listAllDepartmentEntityAsAntdTable() {
